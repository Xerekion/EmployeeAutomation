...
try{
    ...
    console.log(err + "\n  Unable to read the file or convert it to JSON");
}
...
function GenerateLoginData(){
    try{
        ...
        console.log(err + "\n Function Generate Login Data unsuccessful");
    }
}
GenerateLoginData();
...
try{
    ...
    console.log(err + "\n  Unable to write generated Login Data");
}


//const driver = new Builder().forBrowser('chrome').setChromeOptions(options).build();try{
...
async function login(){
    ...
    for(u = 0; u < data.length; u++){
        if(data[u].Is_Created == "Yes"){
            ...
            try{
                ...
                console.log(err + "\n  Unable to add an employee");
            }
            try{
            await driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div[2]/div[2]/form/fieldset/p/input")).click();            if(data[u].Gender == "Male"){
                ...
                console.log(err + "\n  Unable to add personal details");
            }
            try{
                ...
                console.log(err + "\n  Unable to get the employee number from the url");
            }
            try{
    ...
    try{
        ...
        console.log(err + "\n  Unable to add the Is_Created checks");
    }
    try{
        for(u = 0; u < data.length; u++){
